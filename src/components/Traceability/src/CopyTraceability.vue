...
<script>
import { computed, createVNode, defineComponent, provide, reactive, toRefs, watch } from 'vue'
...
export default defineComponent({
  ...
  props: {
    ...
    title: { type: String, default: '复制溯源包' },
  ...
  setup(props, { emit }) {
    ...
    const handleOk = action => {
      emit('done', { action, data: state.traceabilityList[0] })
    }
